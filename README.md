...
2. Pause the printer while jam or runout (Built-in one laser motion sensor chip)
 
3. Width accuracy: +/- 0.015mm (Built-in one high resoultion 0.005mm ccd sensor chip)
